...
public class ProductDetailAdapter extends BaseAdapter {
    ...
    Context context;
    public ProductDetailAdapter(Context context, ArrayList<Object> productArray, ProductDetail productDetail){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            switch (type) {
                case Type_Product:
                    convertView = inflater.inflate(R.layout.prduct_detail_single, parent, false);
                    break;
                case TYPE_DIVIDER:
...
//                title.setText(productVo.getTitle());
                TextView description = (TextView) convertView.findViewById(R.id.tv_descriptionProductDetail);
                description.setText(productVo.getDescription());

                ImageView productImageView = (ImageView) convertView.findViewById(R.id.iv_productDetail);
                ...
                final Button btn = (Button) convertView.findViewById(R.id.button_freeTrial);
