...
public class HomeAdapter extends BaseAdapter {
    ...
    ReadOperationDelegate delegate;

    Context context;

    public HomeAdapter(Context context, ArrayList<Object> homeArray, Home home){
            ...
            case Type_Homeact:
                ...
                seeMoreButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       // if (seeMoreButton.getText().toString().equals(HomeAdapter.showLessButtonTitle)) {
                            // If we want to show half text we are changing value of maximum lines textview can show.
                         //   descriptionLabel.setMaxLines(HomeAdapter.textViewMaxLines);
                          //  seeMoreButton.setText(HomeAdapter.seeMoreButtonTitle);
                       // }  else {
                         //   descriptionLabel.setMaxLines(Integer.MAX_VALUE);
                         //   seeMoreButton.setText(HomeAdapter.showLessButtonTitle);
                       // }
                        if (delegate != null) {
                            delegate.seeMoreButtonTapped(item);
                        }
                    }
                });
